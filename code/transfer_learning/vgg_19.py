...
add_model.add(Dense(1024, activation='sigmoid'))
...
plt.savefig('/home/ubuntu/capstone_project/traffic_images/vgg_19/model_evaluation.png')
plt.show()
...
# save model
model.summary()
model.save('/home/ubuntu/capstone_project/models/vgg_19.h5')
plot_model(model, to_file='/home/ubuntu/capstone_project/traffic_images/vgg_19.png', show_shapes=True,
...
plt.savefig('/home/ubuntu/capstone_project/traffic_images/vgg_19/heat_map.png')
plt.show()
...
plt.savefig('/home/ubuntu/capstone_project/traffic_images/vgg_19/vgg_19_predictions.png')
plt.show()
